...
def run_all_qa(pred_videos_dirpath: Path, database_dirpath: Path, gt_depth_dirpath: Path, frames_datapath: Path,
    ...
    frame_metric_filepaths = [
        ...
        this_filepath.parent / '../../11_MaskedRMSE/src/MaskedRMSE01_RealEstate.py',
        this_filepath.parent / '../../12_MaskedPSNR/src/MaskedPSNR01_RealEstate.py',
        this_filepath.parent / '../../13_MaskedSSIM/src/MaskedSSIM01_RealEstate.py',
        this_filepath.parent / '../../14_MaskedLPIPS/src/MaskedLPIPS01_RealEstate.py',

        this_filepath.parent / '../../05_DepthRMSE/src/DepthRMSE01_RealEstate.py',
        this_filepath.parent / '../../06_DepthMAE/src/DepthMAE01_RealEstate.py',
        this_filepath.parent / '../../07_DepthSROCC/src/DepthSROCC01_RealEstate.py',
        this_filepath.parent / '../../15_MaskedDepthRMSE/src/MaskedDepthRMSE01_RealEstate.py',
        this_filepath.parent / '../../16_MaskedDepthMAE/src/MaskedDepthMAE01_RealEstate.py',
        this_filepath.parent / '../../17_MaskedDepthSROCC/src/MaskedDepthSROCC01_RealEstate.py',
    ]
