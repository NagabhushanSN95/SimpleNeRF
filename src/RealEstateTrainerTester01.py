...
def start_testing(test_configs: dict):
    ...
    gt_depth_dirpath = Path('../data/DenseNeRF/runs/testing/test0001')
    ...
    for scene_num in scene_nums:
        train_configs = {
            ...
            'losses': [
                ...
                # },
                # {
                #     'name': 'PointsAugmentationDepthLoss01',
                #     'iter_weights': {
                #         '0': 0, '10000': 0.1
                #     },
                # },
                ...
                # {
                #     'name': 'ViewsAugmentationDepthLoss01',
                #     'iter_weights': {
                #         '0': 0, '10000': 0.1
                #     },
                # },
                ...
                # {
                #     'name': 'CoarseFineConsistencyLoss01',
                #     'iter_weights': {
                #         '0': 0, '10000': 0.1
                #     },
                # },
...
def demo1b():
    ...
    for scene_num in scene_nums:
        train_configs = {
            'trainer': f'{this_filename}/{Trainer.this_filename}',
            'train_num': train_num,
            'description': 'Main Model: 3 views',
            'database': 'RealEstate10K',
            'database_dirpath': 'databases/RealEstate10K/data',
            'data_loader': {
                'data_loader_name': 'RealEstateDataLoader01',
