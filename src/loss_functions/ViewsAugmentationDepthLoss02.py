...
# Depth MSE loss function between Main Coarse NeRF and Views Augmentation. Reprojection error (patch-wise) is employed
    ...
    def compute_loss(self, input_dict: dict, output_dict: dict, return_loss_maps: bool = False):
        ...
        if self.coarse_mlp_needed and self.augmented_coarse_mlp_needed:
            ...
            if self.ndc:
                ...
                depth_coarse_aug_ndc = output_dict['views_augmentation_depth_ndc_coarse']
        ...
        if self.fine_mlp_needed and self.augmented_fine_mlp_needed:
            ...
            if self.ndc:
                ...
                depth_fine_aug_ndc = output_dict['views_augmentation_depth_ndc_fine']
        ...
        if return_loss_maps:
            loss_dict['loss_maps'] = {}
            if self.coarse_mlp_needed and self.augmented_coarse_mlp_needed:
                loss_dict['loss_maps'][f'{this_filename}_coarse_main'] = coarse_loss_maps[f'{this_filename}_1']
                loss_dict['loss_maps'][f'{this_filename}_coarse_augmented'] = coarse_loss_maps[f'{this_filename}_2']
            if self.fine_mlp_needed and self.augmented_fine_mlp_needed:
                loss_dict['loss_maps'][f'{this_filename}_fine_main'] = fine_loss_maps[f'{this_filename}_1']
